...
현재 stage5는 아직 production 마감 상태는 아니지만, **thread-scoped retrieval + ToolNode + grounded compose answer**까지는 연결된 상태입니다.
